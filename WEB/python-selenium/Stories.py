...
class AppointmentCreation(unittest.TestCase):
    ...
    def test_F(self):
        ...
        self.driver.find_element_by_css_selector(CURA.History.title.css)
        self.driver.find_element_by_css_selector(CURA.History.element.css)
...
class BadLogin(unittest.TestCase):
    ...
    def test_D(self):
        """Wait Failure message"""
        self.driver.find_element_by_css_selector(CURA.Login.Form.failed.css)
