...
# lucrid is invoked (e.g. calling logging.basicConfig).
# In order to capture those output, use the redirectors for the cached
# stream.
# e.g.
#   >>> logging.basicConfig(stream=lucrid.stdout_redirector)
#   >>>
# ------------------------------------------------------------------- #
...
class HTMLTestRunner(TemplateMixin):
    ...
    def generate_report(self, result):
        generator = 'lucrid %s' % __version__
...
class TestProgram(unittest.TestProgram):
    ...
    def runTests(self):
        # Pick lucrid as the default test runner.
        # base class's testRunner parameter is not useful because it means
        # we have to instantiate lucrid before we know self.verbosity.
